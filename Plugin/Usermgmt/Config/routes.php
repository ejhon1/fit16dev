...
Router::connect('/newclient', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'newclient'));
...
Router::connect('/allemployees', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'allemployees'));

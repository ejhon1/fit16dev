...
<div id="dashboard">
    ...
    <?php   if ($this->UserAuth->isAdmin()) { ?>
        <div style="float:left;padding-left:10px"><?php echo $this->Html->link(__("Add Staff Member",true),"/newemployee") ?></div>
        <div style="float:left;padding-left:10px"><?php echo $this->Html->link(__("All Staff Members",true),"/allemployees") ?></div>

<div class="clients index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($client['Archive']['id'], array('controller' => 'archives', 'action' => 'view', $client['Archive']['id'])); ?>
		</td>
		<td><?php echo h($client['Client']['status']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['open_or_closed']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['enquiry_date']); ?>&nbsp;</td>

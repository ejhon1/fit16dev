<div class="archiveloans index">
	<h2><?php echo __('Archiveloans'); ?></h2>
	...
	<tr>
		<td><?php echo h($archiveloan['Archiveloan']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $archiveloan['Archiveloan']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $archiveloan['Archiveloan']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $archiveloan['Archiveloan']['id']), null, __('Are you sure you want to delete # %s?', $archiveloan['Archiveloan']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>

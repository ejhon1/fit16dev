...
<?php echo $this->Form->create('Archiveloan'); ?>
	<fieldset>
		<legend><?php echo __('Edit Archiveloan'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Archiveloan.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Archiveloan.id'))); ?></li>

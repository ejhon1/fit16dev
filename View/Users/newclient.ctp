...
?>
	...
	<fieldset>
        ...
        echo $this->Form->input('Enquiry.born_in_poland', array('type' => 'radio', 'options' => array('Yes' => 'Yes', 'No' => 'No'), 'legend' => 'I was born in Poland'));
        //echo $this->Form->input('Enquiry.nationality_of_parents', array('label' => 'Parents\' Nationality'));
        ...
        echo $this->Form->input('Enquiry.nationality_of_parents', array('type' => 'select', 'multiple' => 'checkbox','options' => array(
            'Mother' => 'My mother is/was Polish', 'Father' =>  'My father is/was Polish'), 'label' => 'Parents\' Nationality'));
        echo $this->Form->input('Enquiry.mother_name', array('label' => 'Mother\'s name','id' =>'test', 'display' => 'none'));
        echo $this->Form->input('Enquiry.father_name', array('label' => 'Father\'s name'));
        echo $this->Form->input('Enquiry.nationality_of_grandparents', array('type' => 'select', 'multiple' => 'checkbox','options' => array(
        ...
        echo $this->Form->input('Enquiry.mat_grandmother_name', array('label' => 'Maternal grandmother\'s name'));
        echo $this->Form->input('Enquiry.mat_grandfather_name', array('label' => 'Maternal grandfather\'s name'));
        echo $this->Form->input('Enquiry.pat_grandmother_name', array('label' => 'Paternal grandmother\'s name'));
        echo $this->Form->input('Enquiry.pat_grandfather_name', array('label' => 'Paternal grandfather\'s name'));
        echo $this->Form->input('Enquiry.nationality_of_others', array('label' => 'Please specify any other family members of Polish decent here'));
        ...
        <div id="panel2" class="panel2">
            <?php
        echo $this->Form->input('Enquiry.serve_in_army', array('type' => 'radio', 'options' => array('Yes' => 'Yes', 'No' => 'No'), 'legend' => 'Did any of your ancestors serve in the Polish army?'));
        echo $this->Form->input('Enquiry.serve_in_army_info', array('label' => 'Please put any known information of this here'));
        echo $this->Form->input('Enquiry.when_left_poland', array('type' => 'select', 'multiple' => 'checkbox','options' => array(
        ...
        echo $this->Form->input('Enquiry.where_left_poland', array('type' => 'select', 'multiple' => 'checkbox','options' => array(
        ...
        echo $this->Form->input('Enquiry.where_left_poland_other', array('label' => ' If other, please specify'));
        echo $this->Form->input('Enquiry.have_passport', array('type' => 'radio', 'options' => array('Yes' => 'Yes', 'No' => 'No'), 'legend' => 'I have/had a Polish passport and wish to renew it'));
        echo $this->Form->input('Enquiry.possess_documents', array('type' => 'radio', 'options' => array('Yes' => 'Yes', 'No' => 'No', 'Not sure' => 'Not Sure'), 'legend' => 'Do you have any Polish documents from your relatives/ancestors?'));
        echo $this->Form->input('Enquiry.possess_documents_types', array('type' => 'select', 'multiple' => 'checkbox','options' => array(
        ...
        echo $this->Form->input('Enquiry.possess_documents_other', array('label' => 'If other, please specify'));
        echo $this->Form->input('Enquiry.other_factors', array('type' => 'select', 'multiple' => 'checkbox','options' => array(

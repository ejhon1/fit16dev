<div class="paperfiles index">
	<h2><?php echo __('Paperfiles'); ?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('archive name'); ?></th>
			<th><?php echo $this->Paginator->sort('status'); ?></th>
            <th><?php echo $this->Paginator->sort('borrowed by'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($paperfiles as $paperfile): ?>
	<tr>
		<td>
			<?php echo $this->Html->link($paperfile['Archive']['archive_name'], array('controller' => 'archives', 'action' => 'view', $paperfile['Archive']['id'])); ?>
		</td>
        <td><?php echo h($paperfile['Employee']['first_name'].' '.$paperfile['Employee']['surname']); ?>&nbsp;</td>
		<td><?php echo h($paperfile['Paperfile']['status']); ?>&nbsp;</td>
		<td class="actions">
